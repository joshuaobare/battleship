...
test("ship produces valid ship coords based on starting coords", ()=> {
    ...
    expect(ship.coord).toStrictEqual([[0,0],[0,1]])
    expect(ship2.coord).toStrictEqual([[0,0],[1,0]])
    expect(ship3.coord).toStrictEqual([[1,1],[1,2],[1,3]])
    expect(ship4.coord).toStrictEqual([[2,5],[3,5],[4,5],[5,5]])
    expect(ship5.coord).toStrictEqual([[2,5],[2,6],[2,7],[2,8],[2,9]])
})